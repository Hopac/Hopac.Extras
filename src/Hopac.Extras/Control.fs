...
type JobChoiceBuilder () =
  member __.Bind (xJ: Job<Choice<'x, 'e>>, x2yJ: 'x -> Job<Choice<'y, 'e>>) : Job<Choice<'y, 'e>> = 
    bind xJ x2yJ
  member job.Bind (xA: Async<Choice<'x, 'e>>, x2yJ: 'x -> Job<Choice<'y, 'e>>) : Job<Choice<'y, 'e>> =
    bind (Async.toJob xA) x2yJ
  member job.Bind (xT: Task<Choice<'x, 'e>>, x2yJ: 'x -> Job<Choice<'y, 'e>>) : Job<Choice<'y, 'e>> =
  ...
  member __.Return (x: 'x) : Job<Choice<'x, 'e>> = Job.result <| Ok x
